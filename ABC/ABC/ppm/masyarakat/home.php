...
<body style="background:grey;">
  ...
  <div class="card-header">
    <ul class="nav nav-pills card-header-pills">
      <li class="nav-item">
        <a class="nav-link text-dark" href="home.php"><ion-icon size="large" name="home-outline"></a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-dark" href="pengaduan.php">pengaduan</a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-dark" href="tanggapan petugas.php">tanggapan petugas</a>
      </li>
      <li class="nav-item">
