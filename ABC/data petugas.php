...
<body style="background:grey;">
  ...
  <div class="card-header">
    <ul class="nav nav-pills card-header-pills">
      ...
      <li class="nav-item">
        <a class="nav-link text-dark" href="data petugas.php">laporan petugas</a>
      </li>
      <li class="nav-item">
       <a class="nav-link text-dark" href="data masyrakat.php">masyrakat</a>
      </li> 
      <li class="nav-item">
...
<div class="container">
  ...
  <tbody>
    ...
    <div class="text-end">
        <a href=".php" class="btn btn-dark">Isi Catatan Perjalanan</a>
  </div>
</body>
</html>